...
export function ContactSection() {
  return (
    <section id="sec-insp" style={{ marginTop: '48px' }}>
      <h2>✦ Contact</h2>
          ...
          <div className="project-content">
            <div className="project-title-row">
              <h3 className="project-title">
                <Link href="mailto:hello@zaidsystems.dev">hello@zaidsystems.dev</Link>
              </h3>
            </div>
            <p className="project-desc">Let's Build Something Interesting.</p>
          </div>
        </article>
      </div>
    </section>
